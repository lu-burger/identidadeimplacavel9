...
const testimonials = [
  ...
  {
    name: "RENATA SILVA",
    role: "Empreendedora — Belo Horizonte",
    text: '"Cheguei sem expectativas e saí completamente transformada. A imersão me fez enxergar bloqueios que eu carregava há décadas. Hoje me reconheço como mulher, mãe e líder com muito mais propósito."',
  },
  {
    name: "CARLOS MENDONÇA",
    role: "Executivo — Curitiba",
    text: '"Nunca imaginei que um evento poderia impactar tanto minha vida profissional e pessoal ao mesmo tempo. Saí com clareza absoluta sobre quem sou e para onde quero ir. Obrigado, Lu!"',
  },
  {
    name: "PATRÍCIA LEMOS",
    role: "Professora — Limeira",
    text: '"A Identidade Implacável foi o divisor de águas da minha vida. Aprendi a me posicionar, a dizer não sem culpa e a viver de acordo com meus valores mais profundos. Uma experiência que recomendo para todos."',
  },
];
