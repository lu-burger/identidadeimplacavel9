      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-center gap-3" style={{ fontFamily: "'Jost', sans-serif", fontSize: "clamp(16px,3.5vw,20px)", color: "var(--txt)" }}>
            ...
            <span>
              <strong style={{ color: "var(--g)", fontWeight: 600, fontSize: "clamp(18px,4vw,22px)" }}>7 de Setembro de 2026</strong>
            </span>
          </div>
          {/* Location */}
          <div className="flex items-center justify-center gap-3" style={{ fontFamily: "'Jost', sans-serif", fontSize: "clamp(16px,3.5vw,20px)", color: "var(--txt)" }}>
          ...
          <div className="flex items-center justify-center gap-3" style={{ fontFamily: "'Jost', sans-serif", fontSize: "clamp(16px,3.5vw,20px)", color: "var(--txt)" }}>
            ...
            <span>
              <strong style={{ color: "var(--g)", fontWeight: 600, fontSize: "clamp(18px,4vw,22px)" }}>9h às 22h</strong>
              <span style={{ fontWeight: 300, fontSize: "clamp(13px,2.5vw,15px)", color: "var(--txs)", marginLeft: 6 }}>(previsão)</span>
            </span>
          </div>
        </div>
